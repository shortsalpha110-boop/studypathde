...
// ---- UNIVERSITY DATABASE ----
// Fields: name, city, type ('universitat'|'hochschule'), strengths[], german[], english[],
//         grades[], ncFree (bool), englishPrograms (bool), semFee (EUR number),
//         tuition, minGrade, programs[], applyUrl, intake, tags[]
const UNIVERSITIES = [
  // ── ELITE / ESTABLISHED ──────────────────────────────────────────
  {
    name:'TU Munich', city:'Munich, Bavaria', type:'universitat',
    strengths:['computer science','engineering','mathematics','natural sciences','data science','informatics','aerospace'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:144,
    tags:['Research Excellence','Top 1%','Global Ranking'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'2.5',
    programs:['Informatics (B.Sc.)','Informatics (M.Sc.)','Electrical Engineering (B.Sc.)','Mechanical Engineering (B.Sc.)','Data Engineering and Analytics (M.Sc.)','Computational Science (M.Sc.)','Finance and Information Management (M.Sc.)'],
    applyUrl:'tum.de/en/studies/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'LMU Munich', city:'Munich, Bavaria', type:'universitat',
    strengths:['medicine','law','social sciences','natural sciences','economics','psychology','biology'],
    german:['c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good'], ncFree:false, englishPrograms:true, semFee:144,
    tags:['Nobel Laureates','Medical School','Historic'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'2.0',
    ...
    applyUrl:'lmu.de/en/study/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Heidelberg University', city:'Heidelberg, Baden-Württemberg', type:'universitat',
    strengths:['medicine','natural sciences','humanities','biology','chemistry','philosophy','psychology'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:175,
    tags:["Germany's Oldest",'Research','Excellence'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 175/sem)', minGrade:'2.5',
    ...
    applyUrl:'uni-heidelberg.de/en/study/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'RWTH Aachen', city:'Aachen, NRW', type:'universitat',
    strengths:['engineering','computer science','mathematics','mechanical engineering','electrical engineering','industrial engineering'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:254,
    tags:['Engineering No.1','Industry Ties','Innovation'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 254/sem)', minGrade:'2.5',
    ...
    applyUrl:'rwth-aachen.de/go/id/einschreibung', intake:'Winter (Oct) mainly',
  },
  {
    name:'KIT Karlsruhe', city:'Karlsruhe, Baden-Württemberg', type:'universitat',
    strengths:['engineering','computer science','architecture','physics','mathematics','data science','optics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:216,
    tags:['Tech Excellence','Engineering','Innovation'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 216/sem)', minGrade:'2.5',
    ...
    applyUrl:'kit.edu/en/study/application.php', intake:'Winter (Oct) mainly',
  },
  {
    name:'University of Frankfurt', city:'Frankfurt, Hesse', type:'universitat',
    strengths:['business','economics','law','social sciences','finance','management','psychology'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:316,
    tags:['Finance Hub','Business','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 316/sem)', minGrade:'3.0',
    ...
    applyUrl:'uni-frankfurt.de/en/studying/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Hamburg', city:'Hamburg', type:'universitat',
    strengths:['business','economics','law','natural sciences','international business','chemistry','biology'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:345,
    tags:['Port City','International Trade','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 345/sem)', minGrade:'3.0',
    ...
    applyUrl:'uni-hamburg.de/en/studium/bewerbung', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Cologne', city:'Cologne, NRW', type:'universitat',
    strengths:['business','law','medicine','social sciences','economics','psychology','accounting'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:302,
    tags:['Large Campus','Business','Medicine'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 302/sem)', minGrade:'3.0',
    ...
    applyUrl:'uni-koeln.de/en/studying/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  // ── BERLIN UNIVERSITIES ──────────────────────────────────────────
  {
    name:'Freie Universität Berlin', city:'Berlin', type:'universitat',
    strengths:['social sciences','history','biology','chemistry','political science','humanities','law','medicine'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:325,
    tags:['International','Research','Berlin'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 325/sem)', minGrade:'3.0',
    ...
    applyUrl:'fu-berlin.de/en/studium/bewerbung', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Humboldt-Universität zu Berlin', city:'Berlin', type:'universitat',
    strengths:['natural sciences','law','economics','arts','philosophy','physics','mathematics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:325,
    tags:['Historic','Research Excellence','Berlin'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 325/sem)', minGrade:'2.5',
    programs:['Computer Science (B.Sc.)','Physics (B.Sc.)','Psychology (B.Sc.)','Economics (B.Sc.)','Law (Staatsexamen)','Biophysics (M.Sc.)','Statistics (M.Sc.)'],
    applyUrl:'hu-berlin.de/en/studies/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'TU Berlin', city:'Berlin', type:'universitat',
    strengths:['engineering','computer science','architecture','economics','mathematics','aerospace','urban planning'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:325,
    tags:['Tech','Berlin','International Students'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 325/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Computer Science (M.Sc.)','Business Informatics (M.Sc.)','Electrical Engineering (B.Sc.)','Urban and Regional Planning (M.Sc.)','Aerospace Engineering (M.Sc.)'],
    applyUrl:'tu-berlin.de/studienbuero/bewerbung', intake:'Winter (Oct) & Summer (Apr)',
  },
  // ── BAVARIA ──────────────────────────────────────────────────────
  {
    name:'FAU Erlangen-Nuremberg', city:'Erlangen, Bavaria', type:'universitat',
    strengths:['engineering','medicine','business','natural sciences','computer science','electrical engineering'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:144,
    tags:['Tech Industry','Siemens HQ Nearby','Engineering'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'2.5',
    ...
    applyUrl:'fau.de/en/education/application', intake:'Winter (Oct) mainly',
  },
  {
    name:'University of Augsburg', city:'Augsburg, Bavaria', type:'universitat',
    strengths:['economics','law','computer science','social sciences','medicine','business','mathematics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:144,
    tags:['Modern Campus','Bavaria','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'3.0',
    programs:['Business Administration (B.Sc.)','Computer Science (B.Sc.)','Law (Staatsexamen)','Social Sciences (B.A.)','Data Science (M.Sc.)','Accounting and Finance (M.Sc.)'],
    applyUrl:'uni-augsburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Bayreuth', city:'Bayreuth, Bavaria', type:'universitat',
    strengths:['law','economics','natural sciences','engineering','african studies','business','polymer science'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:144,
    tags:['Niche Excellence','Bavaria','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'3.0',
    programs:['Law (Staatsexamen)','Business Administration (B.Sc.)','Natural Sciences (B.Sc.)','Engineering (B.Sc.)','African Studies (M.A.)','International Economics (M.Sc.)'],
    applyUrl:'uni-bayreuth.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Würzburg', city:'Würzburg, Bavaria', type:'universitat',
    strengths:['medicine','law','natural sciences','business','pharmacy','biology','chemistry'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:144,
    tags:['Historic','Medicine','Bavaria'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'2.5',
    programs:['Medicine (Staatsexamen)','Law (Staatsexamen)','Pharmacy (Staatsexamen)','Biology (B.Sc.)','Chemistry (B.Sc.)','Business Administration (B.Sc.)'],
    applyUrl:'uni-wuerzburg.de/en/studies/apply', intake:'Winter (Oct) mainly',
  },
  {
    name:'University of Regensburg', city:'Regensburg, Bavaria', type:'universitat',
    strengths:['law','medicine','economics','natural sciences','business','chemistry','biology'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:144,
    tags:['Bavaria','Research','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'3.0',
    programs:['Law (Staatsexamen)','Business Administration (B.Sc.)','Chemistry (B.Sc.)','Medicine (Staatsexamen)','International Business (B.Sc.)','Economics (M.Sc.)'],
    applyUrl:'uni-regensburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Passau', city:'Passau, Bavaria', type:'universitat',
    strengths:['law','economics','computer science','cultural studies','business','information systems'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:144,
    tags:['International','Law','IT'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 144/sem)', minGrade:'3.0',
    programs:['Law (Staatsexamen)','Business Administration (B.Sc.)','Computer Science (B.Sc.)','European Studies (B.A.)','Cultural Studies (B.A.)','Information Systems (M.Sc.)'],
    applyUrl:'uni-passau.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  // ── NRW ──────────────────────────────────────────────────────────
  {
    name:'University of Bonn', city:'Bonn, NRW', type:'universitat',
    strengths:['mathematics','physics','agriculture','law','economics','natural sciences','philosophy'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good'], ncFree:false, englishPrograms:true, semFee:318,
    tags:['Excellence Initiative','Research','Historic'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'2.5',
    programs:['Mathematics (B.Sc.)','Physics (B.Sc.)','Economics (B.Sc.)','Law (Staatsexamen)','Agricultural Sciences (B.Sc.)','Mathematics (M.Sc.)','Data Analytics (M.Sc.)'],
    applyUrl:'uni-bonn.de/en/studying/applying', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Münster', city:'Münster, NRW', type:'universitat',
    strengths:['law','business','chemistry','medicine','social sciences','economics','biology'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:318,
    tags:['Student City','Law','Chemistry'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.0',
    programs:['Law (Staatsexamen)','Business Administration (B.Sc.)','Chemistry (B.Sc.)','Medicine (Staatsexamen)','Social Sciences (B.A.)','Economics (M.Sc.)'],
    applyUrl:'uni-muenster.de/en/studying/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Düsseldorf (HHU)', city:'Düsseldorf, NRW', type:'universitat',
    strengths:['medicine','law','economics','natural sciences','philosophy','pharmacy','biology'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:318,
    tags:['Medicine','NRW','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.0',
    programs:['Medicine (Staatsexamen)','Pharmacy (Staatsexamen)','Law (Staatsexamen)','Economics (B.Sc.)','Biology (B.Sc.)','Chemistry (B.Sc.)'],
    applyUrl:'hhu.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Bochum (RUB)', city:'Bochum, NRW', type:'universitat',
    strengths:['engineering','natural sciences','social sciences','law','economics','computer science','mathematics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['Research','Open Access','NRW'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.0',
    programs:['Electrical Engineering (B.Sc.)','Mechanical Engineering (B.Sc.)','Computer Science (B.Sc.)','Law (Staatsexamen)','Economics (B.Sc.)','Mathematics (B.Sc.)'],
    applyUrl:'rub.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Paderborn', city:'Paderborn, NRW', type:'universitat',
    strengths:['computer science','engineering','economics','mathematics','electrical engineering','business informatics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['IT Excellence','NRW','Applied Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Sc.)','Business Administration (B.Sc.)','Mathematics (B.Sc.)','Business Informatics (M.Sc.)','Software Engineering (M.Sc.)'],
    applyUrl:'uni-paderborn.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Siegen', city:'Siegen, NRW', type:'universitat',
    strengths:['engineering','computer science','economics','social sciences','mathematics','electrical engineering'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['Applied Research','NRW','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Sc.)','Economics (B.Sc.)','Social Sciences (B.A.)','Mechanical Engineering (B.Sc.)'],
    applyUrl:'uni-siegen.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  // ── LOWER SAXONY / OTHER NORTH ───────────────────────────────────
  {
    name:'University of Göttingen', city:'Göttingen, Lower Saxony', type:'universitat',
    strengths:['natural sciences','law','agriculture','social sciences','medicine','mathematics','physics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:387,
    tags:['Nobel Prize Tradition','Research','Excellence'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 387/sem)', minGrade:'3.0',
    programs:['Mathematics (B.Sc.)','Physics (B.Sc.)','Agricultural Sciences (B.Sc.)','Law (Staatsexamen)','Social Sciences (B.A.)','Data Science (M.Sc.)'],
    applyUrl:'uni-goettingen.de/en/applying', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Kiel (CAU)', city:'Kiel, Schleswig-Holstein', type:'universitat',
    strengths:['medicine','natural sciences','economics','agriculture','law','biology','marine science'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:203,
    tags:['Marine Science','Baltic Sea','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 203/sem)', minGrade:'3.0',
    programs:['Medicine (Staatsexamen)','Economics (B.Sc.)','Biology (B.Sc.)','Agricultural Sciences (B.Sc.)','Law (Staatsexamen)','Marine Sciences (M.Sc.)'],
    applyUrl:'uni-kiel.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Greifswald', city:'Greifswald, Mecklenburg', type:'universitat',
    strengths:['medicine','law','natural sciences','social sciences','pharmacy','biology'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:94,
    tags:['Low Fees','Historic','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 94/sem)', minGrade:'3.5',
    programs:['Medicine (Staatsexamen)','Law (Staatsexamen)','Pharmacy (Staatsexamen)','Biology (B.Sc.)','Social Sciences (B.A.)'],
    applyUrl:'uni-greifswald.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Rostock', city:'Rostock, Mecklenburg', type:'universitat',
    strengths:['engineering','natural sciences','medicine','agriculture','maritime','computer science'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:94,
    tags:['Maritime','Low Fees','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 94/sem)', minGrade:'3.5',
    programs:['Mechanical Engineering (B.Sc.)','Computer Science (B.Sc.)','Agricultural Sciences (B.Sc.)','Biology (B.Sc.)','Maritime Systems (M.Sc.)'],
    applyUrl:'uni-rostock.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Mainz (JGU)', city:'Mainz, Rhineland-Palatinate', type:'universitat',
    strengths:['medicine','chemistry','law','social sciences','linguistics','philosophy','physics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:367,
    tags:['Research','Medicine','International'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 367/sem)', minGrade:'3.0',
    programs:['Medicine (Staatsexamen)','Chemistry (B.Sc.)','Law (Staatsexamen)','Social Sciences (B.A.)','Linguistics (B.A.)','Physics (B.Sc.)'],
    applyUrl:'uni-mainz.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Jena (FSU)', city:'Jena, Thuringia', type:'universitat',
    strengths:['natural sciences','medicine','economics','social sciences','pharmacy','optics','chemistry'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:116,
    tags:['Optics Valley','Low Fees','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 116/sem)', minGrade:'3.0',
    programs:['Physics (B.Sc.)','Chemistry (B.Sc.)','Economics (B.Sc.)','Medicine (Staatsexamen)','Pharmacy (Staatsexamen)','Photonics (M.Sc.)'],
    applyUrl:'uni-jena.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Leipzig', city:'Leipzig, Saxony', type:'universitat',
    strengths:['medicine','law','economics','social sciences','sports science','communication','humanities'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:false, englishPrograms:true, semFee:263,
    tags:['Research','Medicine','Culture'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 263/sem)', minGrade:'3.0',
    programs:['Medicine (Staatsexamen)','Law (Staatsexamen)','Economics (B.Sc.)','Sports Science (B.Sc.)','Communication (B.A.)','Social Sciences (B.A.)'],
    applyUrl:'uni-leipzig.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Halle-Wittenberg (MLU)', city:'Halle, Saxony-Anhalt', type:'universitat',
    strengths:['natural sciences','agriculture','social sciences','medicine','chemistry','economics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:71,
    tags:['Lowest Fees','Research','Agriculture'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 71/sem)', minGrade:'3.5',
    programs:['Chemistry (B.Sc.)','Agricultural Sciences (B.Sc.)','Social Sciences (B.A.)','Economics (B.Sc.)','Biology (B.Sc.)'],
    applyUrl:'uni-halle.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Saarland University', city:'Saarbrücken, Saarland', type:'universitat',
    strengths:['computer science','engineering','law','medicine','pharmacy','mathematics'],
    german:['b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:291,
    tags:['Bilingual Region','IT Cluster','Research'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 291/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Sc.)','Law (Staatsexamen)','Medicine (Staatsexamen)','Pharmacy (Staatsexamen)','Cybersecurity (M.Sc.)'],
    applyUrl:'uni-saarland.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'University of Kassel', city:'Kassel, Hesse', type:'universitat',
    strengths:['engineering','architecture','social sciences','agriculture','computer science','design'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:302,
    tags:['Documenta City','Architecture','Applied'], levels:['bachelor','master','phd'],
    tuition:'Free (EUR 302/sem)', minGrade:'3.0',
    programs:['Architecture (B.Sc.)','Mechanical Engineering (B.Sc.)','Computer Science (B.Sc.)','Social Sciences (B.A.)','Renewable Energy (M.Sc.)'],
    applyUrl:'uni-kassel.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  // ── HOCHSCHULEN / UNIVERSITIES OF APPLIED SCIENCES ───────────────
  {
    name:'HTW Berlin', city:'Berlin', type:'hochschule',
    strengths:['engineering','computer science','business','architecture','logistics','design','international business'],
    german:['b1','b2','c1'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:307,
    tags:['Applied Sciences','Practical','International'], levels:['bachelor','master'],
    tuition:'Free (EUR 307/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Eng.)','Business Informatics (B.Sc.)','International Business (B.A.)','Engineering (B.Eng.)','Logistics (B.Eng.)','Game Design (B.A.)'],
    applyUrl:'htw-berlin.de/studium/bewerbung', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule München (HM)', city:'Munich, Bavaria', type:'hochschule',
    strengths:['engineering','computer science','business','design','social work','applied sciences'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:144,
    tags:['Applied Sciences','Munich','Industry Connections'], levels:['bachelor','master'],
    tuition:'Free (EUR 144/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Mechanical Engineering (B.Eng.)','Business Administration (B.A.)','Industrial Engineering (B.Eng.)','Information Systems (M.Sc.)'],
    applyUrl:'hm.edu/en/studying_and_teaching/application', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'HAW Hamburg', city:'Hamburg', type:'hochschule',
    strengths:['engineering','social work','computer science','design','business','health'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:339,
    tags:['Hamburg','Applied','International'], levels:['bachelor','master'],
    tuition:'Free (EUR 339/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Social Work (B.A.)','Design (B.A.)','Business Informatics (B.Sc.)','Renewable Energies (M.Sc.)'],
    applyUrl:'haw-hamburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule RheinMain', city:'Wiesbaden, Hesse', type:'hochschule',
    strengths:['business','engineering','architecture','design','computer science','media'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:302,
    tags:['Rhine-Main Region','Applied','Business'], levels:['bachelor','master'],
    tuition:'Free (EUR 302/sem)', minGrade:'3.0',
    programs:['Business Administration (B.Sc.)','Electrical Engineering (B.Eng.)','Architecture (B.Sc.)','Design (B.A.)','Computer Science (B.Sc.)'],
    applyUrl:'hs-rm.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Darmstadt (h_da)', city:'Darmstadt, Hesse', type:'hochschule',
    strengths:['engineering','computer science','business','design','social sciences','media'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:302,
    tags:['IT Hub','Applied','Hesse'], levels:['bachelor','master'],
    tuition:'Free (EUR 302/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Design (B.A.)','Cybersecurity (M.Sc.)'],
    applyUrl:'h-da.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Mannheim', city:'Mannheim, Baden-Württemberg', type:'hochschule',
    strengths:['engineering','computer science','social sciences','biomedical','business'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Rhine-Neckar','Applied','Engineering'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Mechanical Engineering (B.Eng.)','Social Sciences (B.A.)','Information Technology (M.Sc.)'],
    applyUrl:'hs-mannheim.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Karlsruhe (HKA)', city:'Karlsruhe, Baden-Württemberg', type:'hochschule',
    strengths:['engineering','computer science','business','architecture','mechanical engineering','information management'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Tech City','Applied','Baden-Württemberg'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Mechanical Engineering (B.Eng.)','Architecture (B.Sc.)','Business Administration (B.Sc.)','Information Management (M.Sc.)'],
    applyUrl:'h-ka.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Offenburg', city:'Offenburg, Baden-Württemberg', type:'hochschule',
    strengths:['engineering','computer science','business','media','electrical engineering'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Baden-Württemberg','Applied','International'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Media Technology (B.Eng.)'],
    applyUrl:'hs-offenburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Furtwangen (HFU)', city:'Furtwangen, Baden-Württemberg', type:'hochschule',
    strengths:['computer science','engineering','health','design','digital media','business'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Digital','Applied','Black Forest'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Digital Media (B.Sc.)','Health Informatics (B.Sc.)','Business Informatics (B.Sc.)','Data Science (M.Sc.)'],
    applyUrl:'hs-furtwangen.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Ulm', city:'Ulm, Baden-Württemberg', type:'hochschule',
    strengths:['engineering','computer science','business','electrical engineering','mechatronics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Baden-Württemberg','Applied','Industry'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Mechatronics (B.Eng.)'],
    applyUrl:'hs-ulm.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Aalen', city:'Aalen, Baden-Württemberg', type:'hochschule',
    strengths:['engineering','optics','computer science','business','materials science','industrial engineering'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['Optics','Applied','Baden-Württemberg'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.5',
    programs:['Mechanical Engineering (B.Eng.)','Electrical Engineering (B.Eng.)','Computer Science (B.Sc.)','Optical Engineering (B.Eng.)','Industrial Engineering (M.Eng.)'],
    applyUrl:'hs-aalen.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Reutlingen', city:'Reutlingen, Baden-Württemberg', type:'hochschule',
    strengths:['business','engineering','design','computer science','textile','international management'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:193,
    tags:['International','Fashion','Business'], levels:['bachelor','master'],
    tuition:'Free (EUR 193/sem)', minGrade:'3.0',
    programs:['Business Administration (B.Sc.)','Industrial Engineering (B.Sc.)','Fashion Design (B.A.)','Computer Science (B.Sc.)','International Management (M.Sc.)'],
    applyUrl:'reutlingen-university.de/en/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Ostfalia University', city:'Wolfenbüttel, Lower Saxony', type:'hochschule',
    strengths:['engineering','business','social work','computer science','health','logistics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:387,
    tags:['Lower Saxony','Applied','International'], levels:['bachelor','master'],
    tuition:'Free (EUR 387/sem)', minGrade:'3.5',
    programs:['Mechanical Engineering (B.Eng.)','Computer Science (B.Sc.)','Business Administration (B.Sc.)','Social Work (B.A.)','Logistics (B.Sc.)'],
    applyUrl:'ostfalia.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Niederrhein', city:'Krefeld, NRW', type:'hochschule',
    strengths:['engineering','business','design','health','textile','food technology'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['NRW','Applied','Fashion'], levels:['bachelor','master'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.5',
    programs:['Textile Technology (B.Eng.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Health Management (B.Sc.)'],
    applyUrl:'hs-niederrhein.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Bochum', city:'Bochum, NRW', type:'hochschule',
    strengths:['engineering','computer science','business','mechanical engineering','electrical engineering'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['NRW','Applied','Engineering'], levels:['bachelor','master'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.5',
    programs:['Mechanical Engineering (B.Eng.)','Electrical Engineering (B.Eng.)','Computer Science (B.Sc.)','Business Engineering (B.Sc.)'],
    applyUrl:'hs-bochum.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Bielefeld', city:'Bielefeld, NRW', type:'hochschule',
    strengths:['engineering','business','social sciences','design','health','mathematics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:318,
    tags:['NRW','Applied','Social'], levels:['bachelor','master'],
    tuition:'Free (EUR 318/sem)', minGrade:'3.5',
    programs:['Social Work (B.A.)','Mechanical Engineering (B.Eng.)','Business Administration (B.Sc.)','Design (B.A.)','Health Informatics (B.Sc.)'],
    applyUrl:'hsbi.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Osnabrück', city:'Osnabrück, Lower Saxony', type:'hochschule',
    strengths:['engineering','business','agriculture','social sciences','food','energy'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:387,
    tags:['Agriculture','Applied','Lower Saxony'], levels:['bachelor','master'],
    tuition:'Free (EUR 387/sem)', minGrade:'3.5',
    programs:['Agricultural Sciences (B.Sc.)','Mechanical Engineering (B.Eng.)','Business Administration (B.Sc.)','Social Work (B.A.)','Energy Systems (M.Eng.)'],
    applyUrl:'hs-osnabrueck.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Bremen', city:'Bremen', type:'hochschule',
    strengths:['engineering','business','international studies','shipping','logistics','computer science'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:339,
    tags:['Maritime','International','Applied'], levels:['bachelor','master'],
    tuition:'Free (EUR 339/sem)', minGrade:'3.0',
    programs:['International Business (B.A.)','Mechanical Engineering (B.Eng.)','Computer Science (B.Sc.)','International Management (M.A.)','Maritime Logistics (M.Sc.)'],
    applyUrl:'hs-bremen.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Wismar', city:'Wismar, Mecklenburg', type:'hochschule',
    strengths:['engineering','business','architecture','design','computer science','maritime'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:94,
    tags:['Baltic Sea','Low Fees','Applied'], levels:['bachelor','master'],
    tuition:'Free (EUR 94/sem)', minGrade:'3.5',
    programs:['Architecture (B.Sc.)','Mechanical Engineering (B.Eng.)','Business Administration (B.Sc.)','Design (B.A.)','Maritime Engineering (M.Eng.)'],
    applyUrl:'hs-wismar.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Stralsund', city:'Stralsund, Mecklenburg', type:'hochschule',
    strengths:['engineering','business','tourism','computer science','electrical engineering'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:94,
    tags:['Baltic Sea','Low Fees','Tourism'], levels:['bachelor','master'],
    tuition:'Free (EUR 94/sem)', minGrade:'3.5',
    programs:['Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Tourism (B.A.)','Computer Science (B.Sc.)'],
    applyUrl:'hochschule-stralsund.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'HS Anhalt', city:'Köthen, Saxony-Anhalt', type:'hochschule',
    strengths:['engineering','computer science','agriculture','business','food technology','design'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:71,
    tags:['Saxony-Anhalt','Low Fees','Applied'], levels:['bachelor','master'],
    tuition:'Free (EUR 71/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Agricultural Sciences (B.Sc.)','Mechanical Engineering (B.Eng.)','Business Administration (B.Sc.)'],
    applyUrl:'hs-anhalt.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Magdeburg-Stendal', city:'Magdeburg, Saxony-Anhalt', type:'hochschule',
    strengths:['engineering','social work','business','design','water sciences','rehabilitation'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:71,
    tags:['Saxony-Anhalt','Low Fees','Social'], levels:['bachelor','master'],
    tuition:'Free (EUR 71/sem)', minGrade:'3.5',
    programs:['Social Work (B.A.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Design (B.A.)','Water Engineering (M.Eng.)'],
    applyUrl:'hs-magdeburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Merseburg', city:'Merseburg, Saxony-Anhalt', type:'hochschule',
    strengths:['engineering','computer science','social sciences','chemistry','business','biotechnology'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:71,
    tags:['Saxony-Anhalt','Low Fees','Chemistry'], levels:['bachelor','master'],
    tuition:'Free (EUR 71/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Chemistry (B.Sc.)','Engineering (B.Eng.)','Social Sciences (B.A.)','Business Informatics (M.Sc.)'],
    applyUrl:'hs-merseburg.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Erfurt', city:'Erfurt, Thuringia', type:'hochschule',
    strengths:['architecture','engineering','social sciences','business','applied social work','urban planning'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:116,
    tags:['Thuringia','Applied','Architecture'], levels:['bachelor','master'],
    tuition:'Free (EUR 116/sem)', minGrade:'3.5',
    programs:['Architecture (B.Sc.)','Social Work (B.A.)','Business Administration (B.Sc.)','Urban Planning (M.Sc.)'],
    applyUrl:'fh-erfurt.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Westsächsische Hochschule Zwickau (WHZ)', city:'Zwickau, Saxony', type:'hochschule',
    strengths:['engineering','computer science','business','health','automotive','economics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:263,
    tags:['Automotive','Saxony','Applied'], levels:['bachelor','master'],
    tuition:'Free (EUR 263/sem)', minGrade:'3.5',
    programs:['Automotive Engineering (B.Eng.)','Computer Science (B.Sc.)','Business Administration (B.Sc.)','Health Sciences (B.Sc.)'],
    applyUrl:'fh-zwickau.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Hochschule Mittweida', city:'Mittweida, Saxony', type:'hochschule',
    strengths:['engineering','computer science','business','social sciences','laser technology','media'],
    german:['b2','c1','c2'], english:['b1','b2','c1','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:263,
    tags:['Laser Technology','Saxony','Applied'], levels:['bachelor','master'],
    tuition:'Free (EUR 263/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Electrical Engineering (B.Eng.)','Business Administration (B.Sc.)','Social Work (B.A.)','Applied Laser Technologies (M.Sc.)'],
    applyUrl:'hs-mittweida.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'HTW Dresden', city:'Dresden, Saxony', type:'hochschule',
    strengths:['engineering','business','design','computer science','geoinformatics','environmental engineering'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:263,
    tags:['Dresden','Applied','Technology'], levels:['bachelor','master'],
    tuition:'Free (EUR 263/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Mechanical Engineering (B.Eng.)','Business Administration (B.Sc.)','Design (B.A.)','Geoinformatics (M.Sc.)'],
    applyUrl:'htw-dresden.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'HTWK Leipzig', city:'Leipzig, Saxony', type:'hochschule',
    strengths:['engineering','computer science','business','architecture','media technology','mathematics'],
    german:['b2','c1','c2'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:263,
    tags:['Leipzig','Applied','Engineering'], levels:['bachelor','master'],
    tuition:'Free (EUR 263/sem)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Civil Engineering (B.Eng.)','Business Administration (B.Sc.)','Architecture (B.Sc.)','Data Science (M.Sc.)'],
    applyUrl:'htwk-leipzig.de/en/studies/apply', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'TH Wildau', city:'Wildau, Brandenburg (near Berlin)', type:'hochschule',
    strengths:['computer science','engineering','business','bioinformatics','logistics','artificial intelligence'],
    german:['b1','b2','c1'], english:['b1','b2','c1','c2','native'],
    grades:['excellent','very_good','good','average','below_average'], ncFree:true, englishPrograms:true, semFee:260,
    tags:['Applied Sciences','Near Berlin','Practical'], levels:['bachelor','master'],
    tuition:'Free (EUR 260/sem)', minGrade:'3.5',
    programs:['Computer Science (B.Sc.)','Logistics (B.Eng.)','Business Informatics (B.Sc.)','Bioinformatics (B.Sc.)','European Management (B.A.)','AI and Data Science (M.Sc.)'],
    applyUrl:'th-wildau.de/studium/bewerbung', intake:'Winter (Oct) & Summer (Apr)',
  },
  {
    name:'Jacobs University Bremen', city:'Bremen (English-medium)', type:'universitat',
    strengths:['computer science','engineering','business','natural sciences','data science','international relations'],
    german:['none','a1','a2','b1','b2','c1','c2'], english:['b2','c1','c2','native'],
    grades:['excellent','very_good','good','average'], ncFree:true, englishPrograms:true, semFee:0,
    tags:['100% English','International','Liberal Arts'], levels:['bachelor','master'],
    tuition:'EUR 15,000–20,000/year (scholarships available)', minGrade:'3.0',
    programs:['Computer Science (B.Sc.)','Electrical and Computer Engineering (B.Sc.)','Business Administration (B.A.)','Biochemistry (B.Sc.)','Data Engineering (M.Sc.)','Applied Data Science (M.Sc.)'],
    applyUrl:'constructor.university/admissions', intake:'Winter (Sep) mainly',
  },
];
...
function matchUniversities(profile) {
  ...
  const fieldKws = profile.field.toLowerCase().split(/[\s\/&,]+/).filter(w => w.length > 2);
  ...
  return UNIVERSITIES
    ...
    .map(uni => {
      ...
      // Field match (40%) — partial keyword match against strengths[]
      const strengths = (uni.strengths || []).map(s => s.toLowerCase());
      const fieldMatch = fieldKws.some(kw => strengths.some(s => s.includes(kw) || kw.includes(s)));
      score += fieldMatch ? 40 : 5;

      // Grade match (30%)
      if (uni.grades.includes(profile.grade)) score += 30;

      // Language match (20%)
      if (uni.german.includes(profile.german)) score += 20;
      else if (profile.german !== 'none' && uni.german.some(g => g !== 'none')) score += 8;

      // NC requirement (10%)
      if (uni.ncFree) score += 10;
      else score += 5;
...
function getWhySuited(uni, profile) {
  ...
  const fieldKws = profile.field.toLowerCase().split(/[\s\/&,]+/).filter(w => w.length > 2);
  const strengths = (uni.strengths || []).map(s => s.toLowerCase());
  if (fieldKws.some(kw => strengths.some(s => s.includes(kw) || kw.includes(s)))) reasons.push(`strong programs in ${profile.field}`);
  ...
  if (uni.englishPrograms) reasons.push('offers English-taught programs');
  if (uni.ncFree) reasons.push('no NC/numerus clausus restriction');
...
function renderResults(name, unis) {
  ...
  document.getElementById('unisGrid').innerHTML = unis.map(u => {
    const typeLabel = u.type === 'universitat' ? 'Universit\u00e4t' : 'Hochschule/FH';
    const typeClass = u.type === 'universitat' ? 'badge-uni' : 'badge-fh';
    const engBadge  = u.englishPrograms ? '<span class="uni-badge badge-eng">English Programs</span>' : '';
    const semFee    = u.semFee ? `<span class="uni-meta">Semester fee: \u20ac${u.semFee}</span>` : '';
    return `
    <div class="uni-card">
      <div class="uni-card-top">
        <div class="uni-match-score">Match: ${u.score}%</div>
        <span class="uni-badge ${typeClass}">${typeLabel}</span>
      </div>
      <div class="uni-name">${u.name}</div>
      <div class="uni-city">${u.city}</div>
      <div class="uni-badges-row">${engBadge}${semFee}</div>
